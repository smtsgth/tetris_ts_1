...
const candidates = [
  { DEBOUNCE_MS: 200, DEBOUNCE_HOLD_MS: 500, MAX_INTERMEDIATE_APPLIES_PER_REQ: 3 },
  { DEBOUNCE_MS: 200, DEBOUNCE_HOLD_MS: 800, MAX_INTERMEDIATE_APPLIES_PER_REQ: 1 },
  { DEBOUNCE_MS: 200, DEBOUNCE_HOLD_MS: 800, MAX_INTERMEDIATE_APPLIES_PER_REQ: 3 },
  { DEBOUNCE_MS: 300, DEBOUNCE_HOLD_MS: 800, MAX_INTERMEDIATE_APPLIES_PER_REQ: 3 },
  { DEBOUNCE_MS: 400, DEBOUNCE_HOLD_MS: 800, MAX_INTERMEDIATE_APPLIES_PER_REQ: 1 }
];
...
(async () => {
  ...
  const outPath = path.join(recordingsDir, `long_verify_candidates_summary_${Date.now()}.json`);
