...
const repeats = parseInt(process.argv[3] || '20', 10);
...
(async () => {
  ...
  const outPath = path.join(recordingsDir, `extended_verify_top_summary_${Date.now()}.json`);
  fs.writeFileSync(outPath, JSON.stringify(summary, null, 2), 'utf8');
  console.log('Extended verify complete. Summary saved to', outPath);
})();
