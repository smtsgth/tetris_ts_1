...
const re = /^tuned_250ms_pool4_fixedenv_run(\d+)-report\.json$/;
...
fs.writeFileSync(path+'/tuned_250ms_pool4_fixedenv-all-report.json', JSON.stringify(out, null, 2));
console.log('wrote', path+'/tuned_250ms_pool4_fixedenv-all-report.json');
