...
const re = /^tuned_250ms_pool4_probe_run(\d+)-report\.json$/;
...
fs.writeFileSync(path+'/tuned_250ms_pool4_probe-fixedenv-all-report.json', JSON.stringify(out, null, 2));
console.log('wrote', path+'/tuned_250ms_pool4_probe-fixedenv-all-report.json');
